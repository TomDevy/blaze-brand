...
const Contact = () => {
  ...
  return (
    <div className="contact">
      ...
      <div className="soc-m">
        <a target="_blank" href="https://www.instagram.com/invites/contact/?i=esabljrtzhew&utm_content=pg1ufhi">
          <img src={ig} alt="instagram" />
        </a>
        <a target="_blank" href="https://www.facebook.com/profile.php?id=100089098602386">
          <img src={fb} alt="facebook" />
        </a>
        <a target="_blank" href="https://twitter.com/blazebrandltd1?t=EMKPOsOdx7uVpammVKl5_w&s=09">
          <img src={tw} alt="twitter" />
        </a>
        <a target="_blank" href="https://www.linkedin.com/company/blaze-brand-limited/">
